...
class ListManagerController extends Controller
{
    ...
    public function update(Request $request, int $id)
    {
        try {
            ...
            return redirect()->route('get-list', ['id' => $id, 'sucesso' => true]);
        } catch (Exception $exception) {
            return redirect()->route('get-list', ['id' => $id, 'error' => $exception->getMessage()]);
        }
    }
    ...
    public function get($listId)
    {
        try {
            ...
            view('lists.index', ['error' => $exception->getMessage()]);
        }
    }
}
